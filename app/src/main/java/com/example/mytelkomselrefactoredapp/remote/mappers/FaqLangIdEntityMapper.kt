...
class FaqLangIdEntityMapper @Inject constructor(private val contentEntityMapper: ContentEntityMapper,private val topicEntityMapper: TopicEntityMapper):
    EntityMapper<LangIdModel, LangIdEntity> {
